...
export const REFINEMENT_EFFECTS: Refinement[] = [
  {
    id: "refinement_01",
    description: "カード保存、消滅時、ランダムな敵意固定ダメージ100%(各ターン2回)",
  },
  {
    id: "refinement_02",
    description: "ターン開始時とターン終了後にシールドがある場合、敵全体に固定ダメージ100%",
  },
  ...
  { id: "refinement_07", description: "シールド獲得量と治癒量15%増加" },
  {
    id: "refinement_08",
    description:
      "ダメージを完全に防ぐと、次のターン開始時、1ターンの間、味方のダメージ量10%増加(各ターン1回)",
  },
  {
    id: "refinement_09",
    description: "戦闘開始時、所持中のカードが33枚以上の場合、攻撃カードのダメージ量30%増加",
  },
  {
    id: "refinement_10",
    description: "戦闘開始時、所持中のカードが18枚以上の場合、攻撃カードのダメージ量30%増加",
  },
