...
export const MUTATION_CORE_EFFECTS: MutationCoreEffect[] = [
  ...
  // Exhaust: Damage Boost
  {
    ...
    description: '能力で自分のカード消滅時、1ターンの間、自分の攻撃カードダメージ量 +12%（各ターン3回）',
  },
  {
    id: 'exhaust_damage_boost_lv2',
    level: 2,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '能力で自分のカード消滅時、1ターンの間、自分の攻撃カードダメージ量 +15%（各ターン3回）',
  },
  {
    id: 'exhaust_damage_boost_lv3',
    level: 3,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '能力で自分のカード消滅時、1ターンの間、自分の攻撃カードダメージ量 +18%（各ターン3回）',
  },
  {
    id: 'exhaust_damage_boost_lv4',
    level: 4,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '能力で自分のカード消滅時、1ターンの間、自分の攻撃カードダメージ量 +21%（各ターン3回）',
  },
  ...
  // Discard: Extra Attack
  {
    ...
    level: 1,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '1ターンの間、能力で自分のカードを3枚破棄時、ランダムな敵に追加攻撃 150%（各ターン1回）',
  },
  {
    id: 'discard_extra_attack_lv2',
    level: 2,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '1ターンの間、能力で自分のカードを3枚破棄時、ランダムな敵に追加攻撃 225%（各ターン1回）',
  },
  {
    id: 'discard_extra_attack_lv3',
    level: 3,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '1ターンの間、能力で自分のカードを3枚破棄時、ランダムな敵に追加攻撃 300%（各ターン1回）',
  },
  ...
  // Retain: Damage Boost
  {
    ...
    level: 1,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '自分のカードが保存された場合、次に発動する自分の攻撃カードダメージ量 10% 増加（最大3重複）',
  },
  {
    id: 'retain_damage_boost_lv2',
    level: 2,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '自分のカードが保存された場合、次に発動する自分の攻撃カードダメージ量 12% 増加（最大3重複）',
  },
  {
    id: 'retain_damage_boost_lv3',
    level: 3,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '自分のカードが保存された場合、次に発動する自分の攻撃カードダメージ量 15% 増加（最大3重複）',
  },
  {
    id: 'retain_damage_boost_lv4',
    level: 4,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '自分のカードが保存された場合、次に発動する自分の攻撃カードダメージ量 18% 増加（最大3重複）',
  },
  {
    id: 'retain_damage_boost_lv5',
    level: 5,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '自分のカードが保存された場合、次に発動する自分の攻撃カードダメージ量 20% 増加（最大3重複）',
  },
  ...
  // AP5: Card Enhancement
  {
    ...
    level: 1,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '1ターンの間、APを5以上使用時、1ターンの間、自分のダメージ量/シールド獲得量/治癒量 +30%（各ターン1回）',
  },
  {
    id: 'ap5_enhancement_lv2',
    level: 2,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '1ターンの間、APを5以上使用時、1ターンの間、自分のダメージ量/シールド獲得量/治癒量 +40%（各ターン1回）',
  },
  {
    id: 'ap5_enhancement_lv3',
    level: 3,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '1ターンの間、APを5以上使用時、1ターンの間、自分のダメージ量/シールド獲得量/治癒量 +50%（各ターン1回）',
  },
  {
    id: 'ap5_enhancement_lv4',
    level: 4,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '1ターンの間、APを5以上使用時、1ターンの間、自分のダメージ量/シールド獲得量/治癒量 +60%（各ターン1回）',
  },
  ...
  // Draw: Damage Boost
  {
    ...
    level: 1,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '能力で自分のカードドロー時、1ターンの間、発動時まで自分の攻撃カードダメージ量 15% 増加（各ターン1回）',
  },
  {
    id: 'draw_damage_boost_lv2',
    level: 2,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '能力で自分のカードドロー時、1ターンの間、発動時まで自分の攻撃カードダメージ量 23% 増加（各ターン1回）',
  },
  {
    id: 'draw_damage_boost_lv3',
    level: 3,
    category: MutationCoreEffectCategory.SPECIAL,
    description: '能力で自分のカードドロー時、1ターンの間、発動時まで自分の攻撃カードダメージ量 30% 増加（各ターン1回）',
  },
  ...
  // Hand: Damage Boost
  {
    ...
    level: 1,
    category: MutationCoreEffectCategory.SPECIAL,
    description: 'ターン開始時、手札のカード数だけ、次に発動する自分の攻撃カードのダメージ量 5% 増加',
  },
  {
    id: 'hand_damage_boost_lv2',
    level: 2,
    category: MutationCoreEffectCategory.SPECIAL,
    description: 'ターン開始時、手札のカード数だけ、次に発動する自分の攻撃カードのダメージ量 8% 増加',
  },
 ...
 */
export function getMutationCoreEffectsByLevel(
  level: 1 | 2 | 3 | 4 | 5 | 6
): MutationCoreEffect[] {
