...
export const FORBIDDEN_CARDS: CznCard[] = ([
  ...
  },
  {
    ...
    hiramekiVariations: [{ level: 0, cost: 1, description: "シールド140%。手札のランダムな攻撃カード破棄1。破棄された場合、シールド140%追加で獲得" }],
    seasonLevelVariations: [
      { level: 1, cost: 1, description: "シールド140%。手札のランダムな攻撃カード破棄1。破棄された場合、シールド140%追加で獲得" },
      { level: 2, cost: 1, description: "シールド170%。手札のランダムな攻撃カード破棄1。破棄された場合、シールド170%追加で獲得" },
      { level: 3, cost: 1, description: "シールド200%。手札のランダムな攻撃カード破棄1。破棄された場合、シールド200%追加で獲得" },
    ],
  },
  {
    id: "driven_hunt",
    ...
    hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ35%×3。1ターンの間、不屈2減少" }],
    seasonLevelVariations: [
  ...
  },
  {
    ...
    hiramekiVariations: [{ level: 0, cost: 1, description: "1ターンの間、ダメージ量+50%(最大1重複)。味方に脆弱2" }],
    seasonLevelVariations: [
  ...
  },
  {
    ...
    hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ110%。最大HP50%未満の場合、ダメージ量2倍" }],
    seasonLevelVariations: [
