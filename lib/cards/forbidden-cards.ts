...
import { PERSONA_CARD_IMAGE } from "@/lib/persona-image-paths";
...
export const FORBIDDEN_CARDS: CznCard[] = (
  [
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 0,
          description: "自分の攻撃カードドロー1、1ターンの間、そのカードのダメージ量+50%",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          ...
          cost: 2,
          description:
            "手札のカードが6枚以上の時、ランダムなカード1枚1ターンのコスト0（ターンごとに1回）",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      hiramekiVariations: [
        // Fallback descriptions
        {
          level: 0,
          cost: 1,
          description: "能力でドロー時、治癒40％、ランダムな戦闘員のストレス1減少",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "手札の消滅カード1枚消滅" }],
    },
    {
      id: "crimson_lumen",
      name: "赤いルーメン",
      ...
      hiramekiVariations: [{ level: 0, cost: 3, description: "敵全体にダメージ300%" }],
    },
    {
      id: "amber_lumen",
      name: "黄のルーメン",
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "治癒150%\n調律：シールド150%" }],
    },
    {
      id: "ebony_lumen",
      name: "黒いルーメン",
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 2,
          description: "カードが4枚破棄された場合、アクションポイント1（各ターン1回）",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "シールド180%\n光の加護1" }],
    },
    {
      id: "faceless_woman",
      name: "顔のない女性",
    ...
    },
    {
      ...
      imgUrl: PERSONA_CARD_IMAGE,
      hiramekiVariations: [
        { level: 0, cost: 1, description: "山札からランダムな安息カードを1枚破棄" },
      ],
    },
    {
      id: "persona_07",
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 1,
          description: "墓地のカード数に応じて次に使用する攻撃カードのダメージ量+15％（最大150％）",
        },
      ],
    },
    {
      ...
      imgUrl: PERSONA_CARD_IMAGE,
      hiramekiVariations: [
        { level: 0, cost: 1, description: "防御依存ダメージ250%\n行動カウント2" },
      ],
    },
    {
      id: "persona_14",
    ...
    // Season 4 - Desire cards
    {
      ...
      hiramekiVariations: [
        { level: 0, cost: 2, description: "敵全体にダメージ200%。撃破：ランダムな敵に灼熱4" },
      ],
    ...
    },
    {
      ...
      hiramekiVariations: [
        { level: 0, cost: 1, description: "ダメージ130%。対象が灼熱状態なら、追加攻撃100%" },
      ],
      seasonLevelVariations: [
    ...
    },
    {
      ...
      hiramekiVariations: [
        { level: 0, cost: 1, description: "デバフを所持中の対象に脆弱1。敵全体に弱体化1、灼熱3" },
      ],
      seasonLevelVariations: [
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 1,
          description: "ダメージ120%。対象が苦痛または灼熱状態なら、ダメージ量85%増加",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          level: 2,
          cost: 1,
          description: "ダメージ140%。対象が苦痛または灼熱状態なら、ダメージ量100%増加",
        },
        {
          level: 3,
          cost: 1,
          description: "ダメージ150%。対象が苦痛または灼熱状態なら、ダメージ量125%増加",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          ...
          cost: 2,
          description:
            "ダメージ200%。このターン中に、味方が撃破した敵数に応じて1ターンの間ダメージ量+50%(最大4回)",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          ...
          cost: 2,
          description:
            "ダメージ260%。このターン中に、味方が撃破した敵数に応じて1ターンの間ダメージ量+60%(最大4回)",
        },
        {
          level: 3,
          cost: 2,
          description:
            "ダメージ320%。このターン中に、味方が撃破した敵数に応じて1ターンの間ダメージ量+70%(最大4回)",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 1,
          description: "1ターンの間、自分の能力でドロー時、ランダムな敵に追加攻撃75%(最大3回)",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          level: 2,
          cost: 1,
          description: "1ターンの間、自分の能力でドロー時、ランダムな敵に追加攻撃90%(最大3回)",
        },
        {
          level: 3,
          cost: 1,
          description: "1ターンの間、自分の能力でドロー時、ランダムな敵に追加攻撃110%(最大3回)",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 1,
          description: "ドロー1。ランダムな敵に弱体化、脆弱、苦痛のうち、ランダム効果2回付与",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          level: 2,
          cost: 1,
          description: "ドロー1。ランダムな敵に弱体化、脆弱、苦痛のうち、ランダム効果3回付与",
        },
        {
          level: 3,
          cost: 1,
          description: "ドロー1。敵全体に弱体化、脆弱、苦痛のうち、ランダム効果3回付与",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          ...
          cost: 1,
          description:
            "このターンドローしたカード数に応じて1ターンの間、次に使用する攻撃カードのダメージ量+20%(最大5)",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          ...
          cost: 1,
          description:
            "このターンドローしたカード数に応じて1ターンの間、次に使用する攻撃カードのダメージ量+30%(最大5)",
        },
        {
          level: 3,
          cost: 1,
          description:
            "このターンドローしたカード数に応じて1ターンの間、次に使用する攻撃カードのダメージ量+40%(最大5)",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          ...
          cost: 1,
          description:
            "1ターンの間、対象が所持中のデバフ種類数に応じて与えるダメージ量+20%(最大60%)",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          ...
          cost: 1,
          description:
            "1ターンの間、対象が所持中のデバフ種類数に応じて与えるダメージ量+30%(最大90%)",
        },
        {
          level: 3,
          cost: 1,
          description:
            "1ターンの間、対象が所持中のデバフ種類数に応じて与えるダメージ量+40%(最大120%)",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          ...
          cost: 1,
          description:
            "1ターンの間、他の戦闘員の攻撃カード使用時、ランダムな敵に挟み撃ち60%(最大2回)。挟み撃ちの対象は1ターンの間、士気1減少",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          ...
          cost: 1,
          description:
            "1ターンの間、他の戦闘員の攻撃カード使用時、ランダムな敵に挟み撃ち80%(最大2回)。挟み撃ちの対象は1ターンの間、士気1減少",
        },
        {
          level: 3,
          cost: 1,
          description:
            "1ターンの間、他の戦闘員の攻撃カード使用時、ランダムな敵に挟み撃ち110%(最大2回)。挟み撃ちの対象は1ターンの間、士気1減少",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 2,
          description: "ダメージ200%。撃破：対象が所持中のデバフ数に応じて1ターンの間、士気1",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          level: 2,
          cost: 2,
          description: "ダメージ300%。撃破：対象が所持中のデバフ数に応じて1ターンの間、士気1",
        },
        {
          level: 3,
          cost: 2,
          description: "ダメージ390%。撃破：対象が所持中のデバフ数に応じて1ターンの間、士気1",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 1,
          description: "ダメージ120%。対象が所持中のデバフ種類数に応じてダメージ量+25%(最大100%)",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          level: 2,
          cost: 1,
          description: "ダメージ150%。対象が所持中のデバフ種類数に応じてダメージ量+30%(最大120%)",
        },
        {
          level: 3,
          cost: 1,
          description: "ダメージ170%。対象が所持中のデバフ種類数に応じてダメージ量+40%(最大160%)",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 1,
          description: "対象が所持中のデバフ1個につきシールド40%(最大200%)。苦痛2、灼熱2",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          level: 2,
          cost: 1,
          description: "対象が所持中のデバフ1個につきシールド50%(最大250%)。苦痛4、灼熱4",
        },
        {
          level: 3,
          cost: 1,
          description: "対象が所持中のデバフ1個につきシールド60%(最大300%)。苦痛6、灼熱6",
        },
      ],
    },
    {
      ...
      type: CardType.FORBIDDEN,
      category: CardCategory.SKILL,
      statuses: [CardStatus.SURVIVAL],
      allowedJobs: [JobType.STRIKER, JobType.VANGUARD],
      imgUrl: "/images/cards/season4/cutting_loose.png",
      hiramekiVariations: [
        {
          level: 0,
          cost: 1,
          description:
            "シールド140%。手札のランダムな攻撃カード破棄1。破棄された場合、シールド140%追加で獲得",
        },
      ],
      seasonLevelVariations: [
        {
        ...
        },
        {
          ...
          cost: 1,
          description:
            "シールド170%。手札のランダムな攻撃カード破棄1。破棄された場合、シールド170%追加で獲得",
        },
        {
          level: 3,
          cost: 1,
          description:
            "シールド200%。手札のランダムな攻撃カード破棄1。破棄された場合、シールド200%追加で獲得",
        },
      ],
    },
    {
      ...
      statuses: [CardStatus.SURVIVAL],
      allowedJobs: [JobType.RANGER, JobType.HUNTER],
      imgUrl: "/images/cards/season4/driven_hunt.png",
      hiramekiVariations: [
        { level: 0, cost: 1, description: "ダメージ35%×3。1ターンの間、不屈2減少" },
      ],
      seasonLevelVariations: [
        { level: 1, cost: 1, description: "ダメージ35%×3。1ターンの間、不屈2減少" },
        { level: 2, cost: 1, description: "ダメージ50%×3。1ターンの間、不屈2減少" },
        { level: 3, cost: 1, description: "ダメージ50%×3。1ターンの間、不屈3減少" },
      ],
    },
    {
      id: "feralization",
      ...
      statuses: [CardStatus.SURVIVAL],
      allowedJobs: [JobType.PSIONIC, JobType.CONTROLLER],
      imgUrl: "/images/cards/season4/feralization.png",
      hiramekiVariations: [
        { level: 0, cost: 1, description: "1ターンの間、ダメージ量+50%(最大1重複)。味方に脆弱2" },
      ],
      seasonLevelVariations: [
        { level: 1, cost: 1, description: "1ターンの間、ダメージ量+50%(最大1重複)。味方に脆弱2" },
        { level: 2, cost: 1, description: "1ターンの間、ダメージ量+60%(最大1重複)。味方に脆弱2" },
        { level: 3, cost: 1, description: "1ターンの間、ダメージ量+75%(最大1重複)。味方に脆弱2" },
      ],
    },
    {
      id: "final_struggle",
      ...
      statuses: [CardStatus.SURVIVAL],
      allowedJobs: "all",
      imgUrl: "/images/cards/season4/final_struggle.png",
      hiramekiVariations: [
        { level: 0, cost: 1, description: "ダメージ110%。最大HP50%未満の場合、ダメージ量2倍" },
      ],
      seasonLevelVariations: [
        { level: 1, cost: 1, description: "ダメージ110%。最大HP50%未満の場合、ダメージ量2倍" },
        { level: 2, cost: 1, description: "ダメージ140%。最大HP50%未満の場合、ダメージ量2倍" },
        { level: 3, cost: 1, description: "ダメージ170%。最大HP50%未満の場合、ダメージ量2倍" },
      ],
    },
    {
      id: "harrowing_reign",
      ...
      statuses: [CardStatus.SURVIVAL],
      allowedJobs: "all",
      imgUrl: "/images/cards/season4/harrowing_reign.png",
      hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ160%。ダメージ依存回復20%" }],
      seasonLevelVariations: [
        { level: 1, cost: 1, description: "ダメージ160%。ダメージ依存回復20%" },
        { level: 2, cost: 1, description: "ダメージ210%。ダメージ依存回復20%" },
        { level: 3, cost: 1, description: "ダメージ240%。ダメージ依存回復30%" },
      ],
    },
    {
      id: "marauders_charge",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ120%\n脆弱1" }],
    },
    {
      id: "inner_corruption",
      name: "侵食された内面",
      ...
      hiramekiVariations: [
        {
          ...
          cost: 1,
          description:
            "敵を倒したとき、ランダムな敵に苦痛、灼熱のうち、ランダム効果2個付与\n(各ターン2回)",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "士気1\n敵全体に脆弱2" }],
    },
    {
      ...
      hiramekiVariations: [
        {
          ...
          cost: 2,
          description:
            "能力で持続ダメージ効果付与時、ランダムな敵に固定ダメージ80% × 4\n(各ターン1回、重複不可)",
        },
      ],
    },
    {
