...
export const SHARED_CARDS: CznCard[] = (
  [
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ランダムな戦闘員のストレスを5減少" }],
    },
    {
      id: "shared_03",
      name: "戦闘準備",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ70%\n苦痛4" }],
    },
    {
      id: "shared_65",
      name: "	天上の裁き",
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "ダメージ350%\n報復3" }],
    },
    {
      id: "shared_66",
      name: "損傷戦術",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "このカード消滅時、ドロー2" }],
    },
    {
      id: "shared_69",
      name: "激しい好き嫌い",
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "手札のカードを1枚消滅\n治療100%" }],
    },
    {
      id: "shared_70",
      name: "変異の霊薬",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "ダメージ200%\n脆弱2\n弱体化2" }],
    },
    {
      id: "shared_11",
      name: "渾身",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "シールド350%" }],
    },
    {
      id: "shared_17",
      name: "魔力暴走",
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "免疫2" }],
    },
    {
      id: "shared_18",
      name: "肉弾戦",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "回避1\n次のターンドロー2" }],
    },
    {
      id: "shared_22",
      name: "鉄壁",
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "決意1\n不屈1" }],
    },
    {
      id: "shared_23",
      name: "踏みにじる",
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "ダメージ150%×2\nドロー1" }],
    },
    {
      id: "shared_24",
      name: "ケンカ好き",
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "手札に攻撃カードがない場合ドロー2" }],
    },
    // For Ranger and Hunter jobs
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "ダメージ150%\n標識1" }],
    },
    {
      id: "shared_27",
      name: "とっておきの一発",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ50%×3" }],
    },
    {
      id: "shared_31",
      name: "破滅",
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ300%\n破棄1" }],
    },
    {
      id: "shared_32",
      name: "衝撃",
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "敵全体にダメージ200%\n脆弱2" }],
    },
    {
      id: "shared_33",
      name: "交渉",
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "士気2\n敵全体に士気2" }],
    },
    {
      id: "shared_34",
      name: "酸性ガス",
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "敵全体に損傷3" }],
    },
    {
      id: "shared_35",
      name: "覚悟",
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 2,
          description: "ターン開始時、手札のランダムな攻撃カードを1枚、1ターンの間ダメージ量を+50%",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "ダメージ80%\nドロー1" }],
    },
    {
      id: "shared_37",
      name: "機動射撃",
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "敵全体にダメージ200%" }],
    },
    {
      id: "shared_38",
      name: "奇襲",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "士気1減少\n決意1減少" }],
    },
    {
      id: "shared_49",
      name: "戦略の再構成",
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "次に使うエゴスキルのコストが1減少" }],
    },
    {
      id: "shared_50",
      name: "解消の風",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "治癒250%" }],
    },
    {
      id: "shared_53",
      name: "直観点火",
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 3,
          description: "ターン開始時、味方に最大HP10%固定ダメージ、アクションポイント1獲得",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "敵全体貫通ダメージ230%" }],
    },
    {
      id: "shared_56",
      name: "空虚の放浪者",
      ...
      hiramekiVariations: [
        {
          level: 0,
          cost: 0,
          description: "エゴポイントが2以上の場合、アクションポイントを1獲得、エゴポイントが2減少",
        },
      ],
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "エゴポイント2獲得" }],
    },
    {
      id: "shared_59",
      name: "闇の知識",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ドロー3" }],
    },
  ] satisfies CznCard[]
