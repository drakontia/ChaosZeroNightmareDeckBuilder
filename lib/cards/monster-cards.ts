  ...
  [
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ50%×4\n標識3" }],
    },
    {
      id: "monster_02",
      name: "鬱陶しい代父",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ランダムな敵にダメージ50%×5" }],
    },
    {
      id: "monster_05",
      name: "ウルブズ・ヴェイン",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ダメージ160%\n行動カウント1増加" }],
    },
    {
      id: "monster_09",
      name: "苦痛の熾天使",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "士気2\n敵の士気-2" }],
    },
    {
      id: "monster_13",
      name: "奈落の虫",
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "士気1減少\n決意3減少" }],
    },
    {
      id: "monster_14",
      name: "冷ややかな代父",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "ドロー4" }],
    },
    {
      id: "monster_16",
      name: "精霊フェニックス",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "受けるダメージ量-15%(各ターン1回)" }],
    },
    {
      id: "monster_23",
      name: "陰気な代母",
    ...
    },
    {
      ...
      hiramekiVariations: [{ level: 0, cost: 1, description: "クリスタライズ5" }],
    },
    {
      id: "monster_26",
      name: "ドミニオン",
      ...
      hiramekiVariations: [{ level: 0, cost: 2, description: "ターン開始時士気1" }],
    },
    {
      id: "vine_lord",
      name: "ヴァインロード",
      ...
      hiramekiVariations: [{ level: 0, cost: 0, description: "自分の消滅カードドロー2" }],
    },
    {
      id: "cyborg_automaton",
      name: "サイボーグ・オートマトン",
