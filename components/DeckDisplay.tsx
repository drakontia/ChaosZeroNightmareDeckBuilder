    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 gap-4">
      {sortedCards.map((card) => {
        ...
        if (card.selectedHiddenHiramekiId) {
          const effect = HIDDEN_HIRAMEKI_EFFECTS.find(
        ...
        const leftControls = isSeason4 ? (
          <SeasonLevelControls
            card={card}
            onUpdateSeasonLevel={onUpdateSeasonLevel}
            onUpdateSeasonStatuses={onUpdateSeasonStatuses}
          />
        ...
        return (
          <Card key={card.deckId}>
            <CardFrame
              ...
              descriptionId={
                hasPersonaEngravings || isSeason4
                  ? undefined
