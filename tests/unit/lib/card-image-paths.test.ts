...
describe("getOrganizedCardImagePath", () => {
  it("maps character card images into the character folder", () => {
    expect(
      getOrganizedCardImagePath(
        "fei_starting_1",
        CardType.CHARACTER,
        "/images/cards/fei_starting_1.png",
      ),
  ...
  it("keeps already organized persona image paths unchanged", () => {
    expect(
      getOrganizedCardImagePath(
        "persona_01",
        CardType.FORBIDDEN,
        "/images/cards/common/persona.png",
      ),
    ).toBe("/images/cards/common/persona.png");
  });
  ...
  it("maps season cards into their explicit season folders", () => {
    expect(
      getOrganizedCardImagePath(
        "spore_harvester",
        CardType.FORBIDDEN,
        "/images/cards/spore_harvester.png",
      ),
    ...
    expect(
      getOrganizedCardImagePath(
        "doctrine_of_binding",
        CardType.FORBIDDEN,
        "/images/cards/doctrine_of_binding.png",
      ),
    ...
    expect(
      getOrganizedCardImagePath(
        "traitors_execution",
        CardType.FORBIDDEN,
        "/images/cards/traitors_execution.png",
      ),
    ...
    expect(
      getOrganizedCardImagePath(
        "marauders_charge",
        CardType.FORBIDDEN,
        "/images/cards/marauders_charge.png",
      ),
  ...
  it("leaves non-card public assets untouched", () => {
    expect(
      getOrganizedCardImagePath(
        "card_placeholder",
        CardType.SHARED,
        "/images/other/card_placeholder.png",
      ),
