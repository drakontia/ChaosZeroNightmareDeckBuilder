...
describe("CardSelector", () => {
  ...
  it("renders season card accordions in season4 to season1 order before shared and monster", () => {
    ...
    expect(renderedText.indexOf("Season Cards 4")).toBeLessThan(
      renderedText.indexOf("Season Cards 3"),
    );
    expect(renderedText.indexOf("Season Cards 3")).toBeLessThan(
      renderedText.indexOf("Season Cards 2"),
    );
    expect(renderedText.indexOf("Season Cards 2")).toBeLessThan(
      renderedText.indexOf("Season Cards 1"),
    );
    expect(renderedText.indexOf("Season Cards 1")).toBeLessThan(
      renderedText.indexOf("Shared Cards"),
    );
    expect(renderedText.indexOf("Shared Cards")).toBeLessThan(
      renderedText.indexOf("Monster Cards"),
    );
